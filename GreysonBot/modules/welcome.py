        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Oh,Fighting Skill Immeasurable?Who is that Person?",
                    reply_to_message_id=reply)
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Whoa! A member of the Dev Community just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_text(
                    "GOD! An Elite just joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "Huh a Knight?! Someone with a Knight's Fighting Skill just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_text(
                    "OH YEAH! A Horsemen just joined!",
                    reply_to_message_id=reply)
                continue
            ...
            # Welcome yourself
                ...
                creator = None
                for x in context.bot.get_chat_administrators(
